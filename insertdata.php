...
$user =  "INSERT INTO users(id,name, email, token, created) VALUES (3,'zahir', 'zahir@gmail.com', 'ae2b1fca515949e5d54fb22b8ed95575', '2021-10-21 10:30:00') ";

//table locations - id, user_id (int), district (varchar 255), state (varchar 255),country (varchar 255)
$location = "INSERT INTO locations(id, user_id, district,state,country) VALUES (2,3,'Cheras','Selangor', 'Malaysia')";
