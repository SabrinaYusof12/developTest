...
$user = "INSERT INTO users (id, name, email, token, created) VALUES ('8', 'fyzatest', 'fyzamohd@ymail.com', '$token','$today');";
//table locations - id, user_id (int), district (varchar 255), state (varchar 255),country (varchar 255)
$location = "INSERT INTO locations (id, user_id, district, state, country) VALUES ('8', '8', 'raub', 'pahang','malaysia');";
